"""Let’s combine the luggage check-in process with ticket validation.
Ticket validation happens first followed by luggage check-in."""

"""The conditional statement written in this program is known as nested if statement.
 In this case, an if statement is written within another if statement. 
Similarly, any decision logic can also be written within an else statement."""
